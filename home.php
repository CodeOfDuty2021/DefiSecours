...
<body>
    <div>
    <!-- <div class="lifebuoy">
	<div class="sgl8r8o"></div>
	<div class="n29n237"></div>
	<div class="mo71q15"></div>
	<div class="grqsesn"></div> -->
</div>
...
<div class="container">
    ...
    <h5 style='text-align:center;'>Les Sorties</h5>
    <hr/>
    <table class="table table-bordered">
            <thead class="alert-info">
                <tr>
                    ...
                    <th>Localisation</th>
                    <th>Nom de bateau</th>
                    <th>Nom de sauvteur</th>
                    <th>Nombre des sauvé</th>
                    <th>Nombre décédés</th>
                    <th>Témoiniage</th>				
                </tr>
            </thead>
