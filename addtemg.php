...
<head>
	...
	<link rel="stylesheet" type="text/css" href="style/addtem.css"/>
</head>
						...
						<div class="card-body">
							...
							<form method="POST" class="my-login-validation" novalidate="">
								...
								<div class="form-group">
									...
									<input id="lieu" type="text" class="form-control" name="email" required>
									<div class="invalid-feedback">
										Lieu Invalide
									</div>
								</div>
								...
								<div class="form-group">
									...
									<input id="text" type="text" class="form-control" name="bateau" required data-eye>
									<div class="invalid-feedback">
										Nom du bateau obligatoire
									</div>
								</div>
                                <div class="form-group">
									<label for="sauve">Nombre Sauvé </label>
									<input id="sauve" type="number" class="form-control" name="sauve" required data-eye>
									
								</div>
                                <div class="form-group">
									<label for="password">Nombre Sauvteurs </label>
									<input id="sauvteur" type="number" class="form-control" name="password" required data-eye>
